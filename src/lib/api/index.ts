export { getProducts, getAllProducts, createProduct, updateProduct, deleteProduct } from "./products.function";
...
export { login, getCurrentUser, logout } from "./auth.function";
